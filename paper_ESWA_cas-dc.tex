...
Our main experiments use a 1,000-rater subsample
(Table~\ref{tab:datasets-overview}); Section~\ref{sec:libimseti-limitation}
separately analyzes the full 17.3M-edge graph. We set
$k \in \{5, 10, 20\}$.
...
relative to Borda (Table~\ref{tab:libimseti}).
...
as the budget grows — substantially for $\Delta E$, marginally for ILD
(Table~\ref{tab:robustness}) — the
