...
as the budget grows --- substantially for $\Delta E$ (0.332 at 30\% to
0.185 at 60\%, a 44\% reduction) and marginally for ILD (0.456 to 0.470)
--- the method is robust to the exact choice of budget, and 50\% is a
reasonable, round value within a range that performs consistently well. On Rate My Professors, ILD is stable and
