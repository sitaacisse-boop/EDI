...
\begin{figure}[H]
\centering
 \includegraphics[width=0.4\textwidth]{fig_comparison_100k_1m}
...
graph, no method --- including AURORA --- meaningfully reduces the equity gap,
a limitation traced to a genuine difference in rating behaviour between groups
...
($\Delta E = 0.051$) and correcting the most extreme bias in our evaluation.
...
can favour a post-hoc approach or expose a genuine limit of any single-ranking
...
favouring each mechanism; on Rate My Professors specifically, designing a merge
