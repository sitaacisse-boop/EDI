...
tous les jeux de données, et rapportons le taux de compression $|U'|/|U|$
aux côtés de toutes les métriques EDI.
...
d'équité le plus faible observé ($\Delta E = 0{,}031$) tout en corrigeant
...
l'attribut sensible existe des deux côtés du graphe, AURORA --- comme
les règles de vote classiques --- ne réduit pas l'écart d'équité, ce
